...
![MPPI: 0.1 trees/$$m^2$$ forest-like env](media/demo_mppi.gif "MPPI: 0.1 trees/square meter forest-like env") 
![log-MPPI: 0.2 trees/square meter forest-like env](media/demo_log-mppi.gif)
